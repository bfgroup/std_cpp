...
And finally the uses do not end with that. This facility would also support
runtime compilation, for example for runtime generated source, and other
compilation models where the particular execution platform is not know ahead
of time.
