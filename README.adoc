...
* link:https://rawgit.com/bfgroup/std_cpp/master/doc/package_ecosystem_plan_P1177R0.html[Draft standards proposal for package ecosystem plan.]
* link:https://rawgit.com/bfgroup/std_cpp/master/doc/std_compile_P1178R0.html[Draft standards proposal for `std::compile`]
